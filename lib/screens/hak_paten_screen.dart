...
class HakPatenScreen extends StatefulWidget {
  static const title = 'Hak Paten';
  static const androidIcon = Icon(Icons.library_books);
  static const iosIcon = Icon(CupertinoIcons.news);

  @override
  _HakPatenScreenState createState() => _HakPatenScreenState();
}

class _HakPatenScreenState extends State<HakPatenScreen> {
  ...
  Widget _buildAndroid(context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(HakPatenScreen.title),
      ),
      body: Container(
