...
final List<DataIzinTinggal> dataIzinTinggal = [
  DataIzinTinggal('Definisi Izin Tinggal Kunjungan', 'iconpop/c_definisi.png',
  ...
  DataIzinTinggal('Prosedur Pembuatan Izin Tinggal Kunjungan', 'iconpop/c_definisi.png',
      '1. Penerbitan Izin Tinggal Kunjungan yang menjadi kewenangan Kepala Kantor Imigrasi : \n'
          ...
          '\t\t\tc. Apabila dalam penelitian Kepala Kantor Imigrasi ternyata terdapat indikasi yang meragukan, maka Kepala Kantor Imigrasi memerintahkan Kepala Bidang / Kepala Seksi/ Kepala Subseksi sesuai bidang tugasnya untuk melakukan penelaahan dan menyerahkan hasilnya kepada Kepala Kantor Imigrasi. \n'
          ...
          '\t\t\te. Setelah dilakukan pembayaran biaya imigrasi sebagaimana dimaksud pada huruf d, maka proses selanjutnya dilakukan secara berurutan adalah: \n'
              ...
              '\t\t\t\t\t\tiii. Penandatanganan/otorisasi oleh Kepala Kantor Imigrasi atau Pejabat Imigrasi yang ditunjuk. \n'
          ...
          '\t\t\ta. Petugas Loket melakukan pencatatan penerimaan permohonan dan mengeluarkan Tanda Bukti Penerimaan kepada pemohon yang telah memenuhi persyaratan formal, sekaligus melaksanakan pengecekan daftar cegah tangkal, pengecekan catatan berkas pemohon dan database.\n'
          '\t\t\tb. Apabila permohonan telah di nilai memenuhi syarat, permohonan diteruskan kepada Kepala Kantor Imigrasi atau Pejabat Imigrasi yang ditunjuk untuk dibuatkan surat rekomendasi yang ditujukan kepada Kepala Divisi Keimigrasian dengan tembusan Direktur Jenderal Imigrasi.\n'
          '\t\t\tc. Apabila dalam penelitian Kepala Kantor Imigrasi, ternyata terdapat indikasi bahwa permohonannya perlu ditelaah lebih lanjut, atau diperlukan penelitian lain, Kepala Kantor Imigrasi memerintahkan Kepala Bidang / Kepala Seksi/Kepala Subseksi sesuai bidang tugasnya untuk melakukan penelitian dan melaporkan hasilnya kepada Kepala Kantor Imigrasi. \n'
          '\t\t\td. Permohonan izin tinggal kunjungan diteruskan kepada Kepala Divisi Keimigrasian/Direktur Jenderal Imigrasi untuk memperoleh Surat Keputusan dan Surat Perintah Pelaksanaan. \n'
          '\t\t\te. Dalam hal Surat Perintah Pelaksanaan dari Kepala Divisi Keimigrasian telah diterima, Kepala Kantor Imigrasi memberikan persetujuan penerbitan Izin Tinggal Kunjungan dan berkas/file diteruskan kepada Bendahara Penerimaan untuk dilakukan pembayaran biaya imigrasi sesuai dengan peraturan yang berlaku. \n'
          '\t\t\tf. Setelah dilakukan pembayaran biaya imigrasi sebagaimana dimaksud pada huruf e, maka proses selanjutnya dilakukan secara berurutan adalah : \n'
              '\t\t\t\t\t\ti. Sidik jari dan pengambilan foto yang bersangkutan; \n'
              '\t\t\t\t\t\tii. Registrasi, printing dan penempelan foto;\n'
              '\t\t\t\t\t\tiii. Penandatanganan/otorisasi oleh Kepala Kantor Imigrasi atau Pejabat Imigrasi yang ditunjuk. \n'
          '\t\t\tg. Dalam hal persyaratan telah terpenuhi dan telah dilakukan pembayaran sesuai dengan ketentuan peraturan perundang-undangan, Kepala Kantor Imigrasi atau Pejabat Imigrasi yang ditunjuk dalam waktu paling lama 4 (empat) hari kerja menerbitkan Izin Tinggal kunjungan;\n'
          '\t\t\th. Izin Tinggal Kunjungan yang telah selesai, diteruskan ke Petugas Loket Penyerahan.'),

  DataIzinTinggal('Definisi Izin Tinggal Tetap-Terbatas Perkawinan Campuran', 'iconpop/c_definisi.png',
